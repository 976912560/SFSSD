...
parser.add_argument('--resume', default='./weights5/ssd300_350000_3.318957247328758.pth', type=str,
...
def train():
    ...
    for iteration in range(args.start_iter, cfg['max_iter']):
        ...
        if iteration % 100 == 0:
            ...
            print('iter ' + repr(iteration) + ' || Loss: %.4f' % (loss.item()) + ',Lc: %.4f ||' % (loss_c.item()), end=' ')
        ...
        if iteration != 0 and iteration % 5000 == 0:
            ...
            torch.save(ssd_net.state_dict(), 'weights5/ssd300_' +
                       repr(iteration)+'_'+repr(LOSS/5000) + '.pth')
            LOSS=0
